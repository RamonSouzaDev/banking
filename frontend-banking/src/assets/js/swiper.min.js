      ...
      if (!i.isTouchEvent || 'touchmove' === l.type) {
        ...
        if (!a.allowTouchMove)
          return (
            ...
            void (
              i.isTouched &&
              (C(n, { startX: p, startY: c, currentX: p, currentY: c }), (i.touchStartTime = x()))
            )
          )
        ...
        if (
          ...
          if (
            !(a.params.threshold && Math.sqrt(Math.pow(u, 2) + Math.pow(h, 2)) < a.params.threshold)
          ) {
            var v
                ...
                if ('row' === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
                  var G = Math.floor(I / (i.slidesPerGroup * i.slidesPerColumn)),
                    ...
                    H =
                      0 === G
                        ? i.slidesPerGroup
                        : Math.min(Math.ceil((c - G * k * i.slidesPerGroup) / k), i.slidesPerGroup)
            ...
            if (a.params.loop) {
              ...
              var d = a.slides
                ...
                p = a.slides
                  ...
                  .index()
              ;(n =
                void 0 === d ? p : void 0 === p ? d : p - l == l - d ? l : p - l < l - d ? p : d),
