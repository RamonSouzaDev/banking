...
;(function (r) {
  ...
  A(r, 'parts-3d/Math.js', [r['parts/Globals.js'], r['parts/Utilities.js']], function (b, l) {
    ...
    b.pointCameraDistance = function (b, l) {
      ...
      return Math.sqrt(
        Math.pow(h - b.plotX, 2) + Math.pow(l - b.plotY, 2) + Math.pow(q - b.plotZ, 2)
      )
    }
  ...
  A(r, 'parts-3d/Chart.js', [r['parts/Globals.js'], r['parts/Utilities.js']], function (b, l) {
    function r(b, p) {
      ...
      k > n &&
        (f =
          0 > n ? Math.min(f, (k + e) / (-n + k + e)) : Math.min(f, 1 - (((k + e) / (n + e)) % 1)))
    ...
    x(v, 'afterInit', function () {
      ...
      this.is3d() &&
        (b.series || []).forEach(function (p) {
          'scatter' === (p.type || b.chart.type || b.chart.defaultSeriesType) &&
            (p.type = 'scatter3d')
        })
    })
    ...
    v.prototype.get3dFrame = function () {
      ...
      'auto' === p.axisLabelPosition
        ? ((f = function (a, c) {
            return (
              a.visible !== c.visible || (a.visible && c.visible && a.frontFacing !== c.frontFacing)
            )
          }),
          (p = []),
          ...
          (t = []),
          f(a.bottom, a.front) &&
            t.push({ x: (d + k) / 2, y: c, z: 0, xDir: { x: 1, y: 0, z: 0 } }),
          f(a.bottom, a.back) &&
            t.push({ x: (d + k) / 2, y: c, z: e, xDir: { x: -1, y: 0, z: 0 } }),
          (n = []),
          f(a.top, a.front) && n.push({ x: (d + k) / 2, y: g, z: 0, xDir: { x: 1, y: 0, z: 0 } }),
          f(a.top, a.back) && n.push({ x: (d + k) / 2, y: g, z: e, xDir: { x: -1, y: 0, z: 0 } }),
          (l = []),
          f(a.bottom, a.left) &&
            l.push({ z: (0 + e) / 2, y: c, x: d, xDir: { x: 0, y: 0, z: -1 } }),
          f(a.bottom, a.right) &&
            l.push({ z: (0 + e) / 2, y: c, x: k, xDir: { x: 0, y: 0, z: 1 } }),
          (c = []),
  ...
  A(r, 'parts-3d/Axis.js', [r['parts/Globals.js'], r['parts/Utilities.js']], function (b, l) {
    ...
    h.prototype.swapZ = function (a, d) {
      return this.isZAxis
        ? ((d = d ? 0 : this.chart.plotLeft), { x: d + a.z, y: a.y, z: a.x - d })
        : a
    }
      ...
      'dataLabelsGroup' !== a &&
        ...
        c &&
          (this.chart.columnGroup ||
            (this.chart.columnGroup = this.chart.renderer.g('columnGroup').add(c)),
