...
!(function (e, t) {
      ...
      if (Object.prototype.hasOwnProperty.call(t, n)) {
        ...
        ;(void 0 !== i && void 0 === r) ||
          (o(i) && o(r)
            ? (e[n] = c(i, r))
            : (e[n] =
                'object' == typeof (a = r) && null !== a ? c(Array.isArray(a) ? [] : {}, a) : a))
      }
    var a
    return e
  }
      ...
      return (
        (e.hierarchicalFacets || []).forEach(function (e) {
          if (e.rootPath) {
            ...
            0 < t.length && 0 !== t[0].indexOf(e.rootPath) && (n = n.clearRefinements(e.name)),
    ...
    (S.prototype = {
      ...
      clearRefinements: function (e) {
        var t = {
          ...
          facetsRefinements: b.clearRefinement(this.facetsRefinements, e, 'conjunctiveFacet'),
      ...
      addExcludeRefinement: function (e, t) {
        ...
        return b.isRefined(this.facetsExcludes, e, t)
          ? this
          : this.setQueryParameters({ facetsExcludes: b.addRefinement(this.facetsExcludes, e, t) })
      },
      addDisjunctiveFacetRefinement: function (e, t) {
        ...
        return b.isRefined(this.disjunctiveFacetsRefinements, e, t)
          ? this
          : this.setQueryParameters({
              disjunctiveFacetsRefinements: b.addRefinement(this.disjunctiveFacetsRefinements, e, t)
            })
      },
      ...
      toggleDisjunctiveFacetRefinement: function (e, t) {
        ...
        return this.setQueryParameters({
          disjunctiveFacetsRefinements: b.toggleRefinement(this.disjunctiveFacetsRefinements, e, t)
        })
      },
      ...
      isDisjunctiveFacetRefined: function (e, t) {
        return !!this.isDisjunctiveFacet(e) && b.isRefined(this.disjunctiveFacetsRefinements, e, t)
      },
  ...
  function H(l, n) {
    ...
    Object.keys(d).forEach(function (e) {
      ...
      if (n) {
        ...
        f.hierarchicalFacets[i][r] = { attribute: e, data: t, exhaustive: c.exhaustiveFacetsCount }
      } else {
        var a,
        ...
        s &&
          ((a = h[e]),
          (f.disjunctiveFacets[a] = { name: e, data: t, exhaustive: c.exhaustiveFacetsCount }),
        ...
        if (!(0 === c.length || c[0].split(o).length < 2)) {
          ...
          Object.keys(u).forEach(function (t) {
            ...
            if (-1 !== r) {
              ...
              f.hierarchicalFacets[n][r].data = m(i, e, f.hierarchicalFacets[n][r].data)
            }
          }),
            r++
        }
      ...
      Object.keys(l.facetsExcludes).forEach(function (t) {
        var e = l.facetsExcludes[t],
          n = u[t]
        ;(f.facets[n] = { name: t, data: c.facets[t], exhaustive: c.exhaustiveFacetsCount }),
          e.forEach(function (e) {
            ...
            i.push(
              (function (e, t, n, r) {
                var i = e.getHierarchicalFacetByName(t),
                  ...
                  l = (c && c.exhaustive) || !1,
                  h = (c && c.path) || ''
                return { type: 'hierarchical', attributeName: t, name: h, count: u, exhaustive: l }
  ...
  ;((W.EventEmitter = W).prototype._events = void 0),
    ...
    (W.prototype.on = W.prototype.addListener =
      function (e, t) {
        ...
        return (
          this._events || (this._events = {}),
          this._events.newListener && this.emit('newListener', e, $(t.listener) ? t.listener : t),
          this._events[e]
            ? z(this._events[e])
  ...
  var X = Y,
    G = {
        ...
        return (
          ...
          a.getRefinedHierarchicalFacets().forEach(function (e) {
            ...
            0 < n.length &&
              ...
              s.push({ indexName: i, params: G._getDisjunctiveFacetSearchParams(a, e, !0) })
          }),
          s
        )
      },
      ...
      getSearchForFacetQuery: function (e, t, n, r) {
        ...
        return 'number' == typeof n && (a.maxFacetHits = n), p({}, G._getHitsSearchParams(i), a)
      }
    },
    Z = G,
    ee = '3.1.1'
  ...
  J(te, e.EventEmitter),
    ...
    (te.prototype.searchOnce = function (e, t) {
      ...
      if ((this._currentNbQueries++, this.emit('searchOnce', { state: n }), !t))
        return this.client.search(r).then(
          ...
          function (e) {
            throw (
              (i._currentNbQueries--, 0 === i._currentNbQueries && i.emit('searchQueueEmpty'), e)
            )
          }
        )
      this.client
    ...
    (te.prototype.searchForFacetValues = function (t, e, n, r) {
      ...
      return (
        ...
        (i
          ...
          function (e) {
            throw (
              (c._currentNbQueries--, 0 === c._currentNbQueries && c.emit('searchQueueEmpty'), e)
            )
          }
        )
      )
    ...
    (te.prototype.clearRefinements = function (e) {
      return (
        this._change({ state: this.state.resetPage().clearRefinements(e), isPageReset: !0 }), this
      )
    }),
    ...
    (te.prototype.addFacetRefinement = function (e, t) {
      return (
        this._change({ state: this.state.resetPage().addFacetRefinement(e, t), isPageReset: !0 }),
        this
      )
    }),
    ...
    (te.prototype.addFacetExclusion = function (e, t) {
      return (
        this._change({ state: this.state.resetPage().addExcludeRefinement(e, t), isPageReset: !0 }),
        this
      )
    }),
    ...
    (te.prototype.addTag = function (e) {
      return (
        this._change({ state: this.state.resetPage().addTagRefinement(e), isPageReset: !0 }), this
      )
    }),
    ...
    (te.prototype.setQueryParameter = function (e, t) {
      return (
        this._change({ state: this.state.resetPage().setQueryParameter(e, t), isPageReset: !0 }),
        this
      )
    }),
    ...
    (te.prototype._change = function (e) {
      ...
      t !== this.state &&
        ((this.state = t),
        this.emit('change', { state: this.state, results: this.lastResults, isPageReset: n }))
    }),
      ...
      !(function (R) {
            ...
            function b(e, t) {
              if (
                ...
                for (var n, r = p; r < f.length; r++)
                  f[r].text &&
                    ((n = f[r + 1]) && '>' == n.tag && (n.indent = f[r].text.toString()),
                    f.splice(r, 1))
              else t || f.push({ tag: '\n' })
              ;(d = !1), (p = f.length)
            }
        ...
        function o(e) {
          ...
          for (var n in e.partials)
            t.push(
              '"' + f(n) + '":{name:"' + f(e.partials[n].name) + '", ' + o(e.partials[n]) + '}'
            )
          return (
            'partials: {' +
            t.join(',') +
            ...
            (function (e) {
              var t = []
              for (var n in e) t.push('"' + f(n) + '": function(c,p,t,i) {' + e[n] + '}')
              return '{ ' + t.join(',') + ' }'
            })(e.subs)
          )
        }
        ...
        ;(R.generate = function (e, t, n) {
          ...
          (R.codegen = {
            ...
            '^': function (e, t) {
              ;(t.code += 'if(!t.s(t.' + d(e.n) + '("' + f(e.n) + '",c,p,1),c,p,1,0,0,"")){'),
                R.walk(e.nodes, t),
                (t.code += '};')
            },
            '>': m,
          ...
          (R.walk = function (e, t) {
            for (var n, r = 0, i = e.length; r < i; r++) (n = R.codegen[e[r].tag]) && n(e[r], t)
            return t
          }),
          (R.parse = function (e, t, n) {
            return (function e(t, n, r, i) {
              ...
              for (a = r[r.length - 1]; 0 < t.length; ) {
                ...
                if (R.tags[c.tag] <= R.tags.$ || l(c, i)) r.push(c), (c.nodes = e(t, c.tag, r, i))
                else {
                  if ('/' == c.tag) {
      ...
      !(function (e) {
        ...
        ;(e.Template = function (e, t, n, r) {
          ...
          (e.Template.prototype = {
            ...
            rs: function (e, t, n) {
              var r = e[e.length - 1]
              if (h(r)) for (var i = 0; i < r.length; i++) e.push(r[i]), n(e, t, this), e.pop()
              else n(e, t, this)
            },
            ...
            d: function (e, t, n, r) {
              ...
              return (
                !(r && !s) &&
                (r || 'function' != typeof s || (t.push(c), (s = this.mv(s, t, n)), t.pop()), s)
              )
            },
            f: function (e, t, n, r) {
  ...
  function ye(e) {
    ...
    if (!('string' === o) && !c)
      throw new Error(
        "Template must be 'string' or 'function', was '".concat(o, "' (key: ").concat(n, ')')
      )
    if (c) return s(a)
      ...
      return t.reduce(function (e, t) {
        ...
        return (function (e, t) {
          ...
          (function (e, t) {
            ...
            (function (e, t) {
              var n = he([].concat(e.ruleContexts).concat(t.ruleContexts).filter(Boolean))
              ...
              (function (e, t) {
                ...
                (function (e, t) {
                  return e.setQueryParameters({
                    facetsRefinements: D({}, e.facetsRefinements, {}, t.facetsRefinements)
                  })
                })(
                  (function (e, t) {
                    return e.setQueryParameters({
                      facetsExcludes: D({}, e.facetsExcludes, {}, t.facetsExcludes)
                    })
                  })(
                    (function (e, t) {
                      return e.setQueryParameters({
                      ...
                      (function (e, t) {
                        return e.setQueryParameters({
                          numericRefinements: D({}, e.numericRefinements, {}, t.numericRefinements)
                        })
                      })(
                        (function (e, t) {
    ...
    return Array.isArray(e)
      ? (function (e) {
          var t = B(e, 1)[0],
            ...
            s = n[3]
          if (!(r && i && a && s))
            throw new Error('Invalid value for "insideBoundingBox" parameter: ['.concat(e, ']'))
    ...
    return (function n(e) {
      return e.filter(Ve).reduce(function (e, t) {
        return e.concat.apply(
          e,
          [{ indexId: t.getIndexId(), results: t.getResults(), helper: t.getHelper() }].concat(
            w(n(t.getWidgets()))
          )
        )
      }, [])
  ...
  function Ke(e) {
    ...
    return {
      ...
      init: function (e) {
        ...
        ;(f = n), (d = r), (h = i[u] || {})
        var a = n.mainHelper,
          s = $e(l, { uiState: h, initialSearchParameters: new se.SearchParameters({ index: c }) })
  ...
  function nt(e) {
    var t = e.attribute,
      ...
      c = tt({ descendantName: 'highlighted' }) + (s.highlighted ? ' '.concat(s.highlighted) : '')
    return o
      .replace(new RegExp(Ye.highlightPreTag, 'g'), '<'.concat(r, ' class="').concat(c, '">'))
  ...
  function it(e) {
    var t = e.attribute,
      ...
      c = rt({ descendantName: 'highlighted' }) + (s.highlighted ? ' '.concat(s.highlighted) : '')
    return o
      .replace(new RegExp(Ye.highlightPreTag, 'g'), '<'.concat(r, ' class="').concat(c, '">'))
      .replace(new RegExp(Ye.highlightPostTag, 'g'), '</'.concat(r, '>'))
  }
  ...
  function lt(e, t, n, r, i, a, s, o, c, u, l, h, f) {
    ...
    for (var v = 0; v < m.length; ++v) {
      ...
      ;(i && null === d[y]) ||
        (xt(d)
          ? ut(p, lt(d[y], 'function' == typeof n ? n(t, y) : t, n, r, i, a, s, o, c, u, l, h, f))
          : ut(p, lt(d[y], t + (c ? '.' + y : '[' + y + ']'), n, r, i, a, s, o, c, u, l, h, f)))
    }
    return p
  }
  function ht(e, t, n) {
    if (e) {
      ...
      for (var c = 0; 0 < n.depth && null !== (a = i.exec(r)) && c < n.depth; ) {
        if (
          ((c += 1),
          !n.plainObjects && Mt.call(Object.prototype, a[1].slice(1, -1)) && !n.allowPrototypes)
        )
          return
        o.push(a[1])
      }
  ...
  var pt = Object.prototype.hasOwnProperty,
          ...
          (97 <= s && s <= 122)
            ...
            : s < 128
              ...
              : s < 2048
                ...
                : s < 55296 || 57344 <= s
                  ? (i += vt[224 | (s >> 12)] + vt[128 | ((s >> 6) & 63)] + vt[128 | (63 & s)])
                  : ((a += 1),
      ...
      merge: function r(i, a, s) {
        ...
        if ('object' != typeof a) {
          if (gt(i)) i.push(a)
            ...
            ;((s && (s.plainObjects || s.allowPrototypes)) || !pt.call(Object.prototype, a)) &&
              (i[a] = !0)
          }
          return i
        }
    ...
    Tt = {
      ...
      parse: function (e, t) {
        var n = (function (e) {
          ...
          return {
            ...
            allowPrototypes:
              'boolean' == typeof e.allowPrototypes ? e.allowPrototypes : Lt.allowPrototypes,
            arrayLimit: 'number' == typeof e.arrayLimit ? e.arrayLimit : Lt.arrayLimit,
            charset: t,
            charsetSentinel:
              'boolean' == typeof e.charsetSentinel ? e.charsetSentinel : Lt.charsetSentinel,
            ...
            parameterLimit:
              'number' == typeof e.parameterLimit ? e.parameterLimit : Lt.parameterLimit,
            parseArrays: !1 !== e.parseArrays,
            plainObjects: 'boolean' == typeof e.plainObjects ? e.plainObjects : Lt.plainObjects,
            strictNullHandling:
                    ...
                    if (t.charsetSentinel)
                      for (n = 0; n < s.length; ++n)
                        0 === s[n].indexOf('utf8=') &&
                          ('utf8=%E2%9C%93' === s[n]
                            ? (c = 'utf-8')
                            : 'utf8=%26%2310003%3B' === s[n] && (c = 'iso-8859-1'),
                          (o = n),
                          (n = s.length))
                    for (n = 0; n < s.length; ++n)
                      if (n !== o) {
                        ...
                        ;(l =
                          -1 === d
                            ? ((u = t.decoder(h, Lt.decoder, c)), t.strictNullHandling ? null : '')
                          ...
                          l && t.comma && -1 < l.indexOf(',') && (l = l.split(',')),
                          Mt.call(r, u) ? (r[u] = yt.combine(r[u], l)) : (r[u] = l)
                      }
                    return r
                  })(e, n)
                : e,
      ...
      stringify: function (e, t) {
        var n,
          ...
          i = (function (e) {
            ...
            return (
              ...
              {
                addQueryPrefix:
                  'boolean' == typeof e.addQueryPrefix ? e.addQueryPrefix : It.addQueryPrefix,
                allowDots: void 0 === e.allowDots ? It.allowDots : !!e.allowDots,
                charset: t,
                charsetSentinel:
                  'boolean' == typeof e.charsetSentinel ? e.charsetSentinel : It.charsetSentinel,
                ...
                encodeValuesOnly:
                  'boolean' == typeof e.encodeValuesOnly ? e.encodeValuesOnly : It.encodeValuesOnly,
                filter: i,
                formatter: r,
                serializeDate:
                  'function' == typeof e.serializeDate ? e.serializeDate : It.serializeDate,
                skipNulls: 'boolean' == typeof e.skipNulls ? e.skipNulls : It.skipNulls,
        ...
        'function' == typeof i.filter ? (r = (0, i.filter)('', r)) : xt(i.filter) && (n = i.filter)
        var a,
          s = []
        ...
        return (
          i.charsetSentinel &&
            ('iso-8859-1' === i.charset ? (h += 'utf8=%26%2310003%3B&') : (h += 'utf8=%E2%9C%93&')),
          0 < l.length ? h + l : ''
        )
      }
    },
      ...
      return (
        k(u, [
            ...
            value: function (e) {
              ...
              this.writeTimer && window.clearTimeout(this.writeTimer),
                (this.writeTimer = window.setTimeout(function () {
                  mt(r), window.history.pushState(e, r || '', n), (t.writeTimer = void 0)
                }, this.writeDelay))
            }
          },
          {
          ...
          },
          {
            key: 'createURL',
            value: function (e) {
              return this._createURL({ qsModule: Tt, routeState: e, location: window.location })
            }
          },
          {
            key: 'dispose',
            value: function () {
              this._onPopState && window.removeEventListener('popstate', this._onPopState),
                this.writeTimer && window.clearTimeout(this.writeTimer),
                this.write({})
            }
          }
            ...
            (function (e) {
              ...
              return function (e) {
                ...
                return (
                  ...
                  (a._initialUiState = D({}, a._initialUiState, {}, s.routeToState(r.read()))),
                  {
                    ...
                    subscribe: function () {
                      r.onUpdate(function (e) {
                        ...
                        !(function t(e, n) {
                          ...
                          e.getHelper().overrideStateWithoutTriggeringChangeEvent(r),
                            a.scheduleSearch()
                        })
                      })
                    },
        ...
        k(v, [
          ...
          },
          {
            ...
            value: function (e) {
              if (!Array.isArray(e))
                throw new Error(
                  Et('The `addWidgets` method expects an array of widgets. Please use `addWidget`.')
                )
              if (
                e.some(function (e) {
                  return 'function' != typeof e.init && 'function' != typeof e.render
                ...
                throw new Error(
                  Et('The widget definition expects a `render` and/or an `init` method.')
                )
          ...
          },
          {
            ...
            value: function () {
              var r = this
              if (this.started)
                throw new Error(Et('The `start` method has already been called once.'))
          ...
          },
          {
            ...
            value: function (e) {
              var t = 0 < arguments.length && void 0 !== e ? e : {}
              if (!this.started)
                throw new Error(Et('The `start` method needs to be called before `createURL`.'))
          ...
          },
          {
            ...
            value: function () {
              if (!this.mainHelper)
                throw new Error(Et('The `start` method needs to be called before `refresh`.'))
    ...
    return (
      ...
      function () {
        ...
        if (a.includedAttributes && a.excludedAttributes)
          throw new Error(
            Ht('The options `includedAttributes` and `excludedAttributes` cannot be used together.')
          )
        function s() {
          return h.refine()
        }
    ...
    return (
      ...
      function (c) {
        if ((c || {}).includedAttributes && (c || {}).excludedAttributes)
          throw new Error(
            Qt('The options `includedAttributes` and `excludedAttributes` cannot be used together.')
          )
        var e = c || {},
        ...
        return {
          ...
          init: function (e) {
            var t,
              ...
              a = h(qt({ results: {}, helper: n, includedAttributes: u, excludedAttributes: l }))
            function s(e) {
    ...
    return (
      ...
      function () {
        ...
        return {
          ...
          _prepareFacetValues: function (e, i) {
            ...
            return e.slice(0, this.getLimit()).map(function (e) {
              var t = e.name,
                ...
                r = O(e, ['name', 'path'])
              return (
                Array.isArray(r.data) && (r.data = a._prepareFacetValues(r.data, i)),
                D({}, r, { label: t, value: n })
              )
            })
          },
          ...
          dispose: function (e) {
            var t = e.state
            return R(), t.removeHierarchicalFacet(y).setQueryParameter('maxValuesPerFacet', void 0)
          },
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            var i = e.removeHierarchicalFacet(y).addHierarchicalFacet({
                name: y,
                attributes: c,
                separator: u,
                rootPath: h,
    ...
    return (
      ...
      function () {
        ...
        return {
          ...
          init: function (e) {
            var t = e.instantSearchInstance
            o({ hits: [], results: void 0, instantSearchInstance: t, widgetParams: i }, !0)
          },
          render: function (e) {
            var t = e.results,
              n = e.instantSearchInstance
            ...
            ;(t.hits = Qe(t.hits, t.page, t.hitsPerPage)),
              ...
              (t.hits = s(t.hits)),
              (t.hits.__escaped = r),
              o({ hits: t.hits, results: t, instantSearchInstance: n, widgetParams: i }, !1)
          },
          dispose: function (e) {
            var t = e.state
            return (
  ...
  function ln(e, t, n) {
    ...
    return (
      (s = t.key), null != (a = t.ref) && delete t.ref, null != s && delete t.key, hn(e, t, s, a)
    )
  }
  function hn(e, t, n, r) {
    var i = {
          ...
          if (
            ...
            if ((null == m && (m = f), null != e.l)) (f = e.l), (e.l = null)
              ...
              e: if (null == o || o.parentNode !== t) t.appendChild(f)
                ...
                for (d = o, l = 0; (d = d.nextSibling) && l < v; l += 2) if (d == f) break e
                t.insertBefore(f, o)
              }
        ...
        t
          ? t(
              (function (e) {
                ...
                if ('string' == typeof e || 'number' == typeof e) return hn(null, e, null, null)
  ...
  function wn(e, t, n, r, i) {
    var a, s, o, c, u
    if (
      'key' === (t = i ? ('className' === t ? 'class' : t) : 'class' === t ? 'className' : t) ||
      'children' === t
    );
    else if ('style' === t)
      ...
      e: if ('function' == typeof R) {
        if (
          ...
          if (
            ...
            !o && null != h.shouldComponentUpdate && !1 === h.shouldComponentUpdate(v, h.__s, b))
          ) {
            for (
              h.props = v,
                h.state = h.__s,
        ...
        for (
          d = h.props,
            ...
            t.__k = bn(null != l && l.type == fn && null == l.key ? l.props.children : l),
            null != h.getChildContext && (r = cn(cn({}, r), h.getChildContext())),
            f || null == h.getSnapshotBeforeUpdate || (p = h.getSnapshotBeforeUpdate(d, m)),
          ...
          return (
            null === t.type
              ...
              : t !== n &&
                ...
                o ||
                  ((h || l) &&
                    ((h && l && h.__html == l.__html) || (e.innerHTML = (h && h.__html) || ''))),
                (function (e, t, n, r, i) {
                  var a
  ...
  function Tn(c) {
    ...
    return (
      ...
      function () {
        ...
        if (0 === n.length) throw new Error(Ln('A default value must be specified in `items`.'))
        if (1 < n.length)
    ...
    return (
      ...
      function () {
        ...
        return {
              ...
              d(
                {
                  ...
                  isShowingMore: this.isShowingMore,
                  toggleShowMore: this.cachedToggleShowMore,
                  canToggleShowMore: l && (this.isShowingMore || i.length > this.getLimit())
                },
                !1
              )
          },
          dispose: function (e) {
            var t = e.state
            return a(), t.removeHierarchicalFacet(c).setQueryParameter('maxValuesPerFacet', void 0)
          },
          getWidgetState: function (e, t) {
          ...
          getWidgetSearchParameters: function (e, t) {
            var n = t.uiState,
              r = n.menu && n.menu[c],
              i = e.removeHierarchicalFacet(c).addHierarchicalFacet({ name: c, attributes: [c] }),
              a = i.maxValuesPerFacet || 0,
              s = Math.max(a, l ? h : u),
              o = i.setQueryParameter('maxValuesPerFacet', s)
            return r
        ...
        return {
          ...
          getWidgetState: function (e, t) {
            var n = t.searchParameters.getNumericRefinements(u),
              r = n['='] && n['='][0]
            if (r || 0 === r)
              return D({}, e, { numericMenu: D({}, e.numericMenu, C({}, u, ''.concat(n['=']))) })
            var i = (n['>='] && n['>='][0]) || '',
              a = (n['<='] && n['<='][0]) || ''
            return '' === i && '' === a
              ? e
              : D({}, e, {
                  numericMenu: D({}, e.numericMenu, C({}, u, ''.concat(i, ':').concat(a)))
                })
          },
          getWidgetSearchParameters: function (e, t) {
            var n = t.uiState,
  ...
  function Qn(e, t, n) {
    ...
    if (
      (Bn(r, t, i) || (r = r.removeNumericRefinement(t)), void 0 !== i.start && void 0 !== i.end)
    ) {
  ...
  function zn(h) {
    ...
    return (
      ...
      function () {
        ...
        if (x && N && _ < P) throw new Error($n("The `max` option can't be lower than `min`."))
        function F(e) {
        ...
        return {
          ...
          _refine: function (R, w) {
            return function () {
              var e,
                t,
                n = B(0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [], 2),
                r = n[0],
                i = n[1],
                a = w.min,
                s = w.max,
          ...
          dispose: function (e) {
            ...
            return (n.numericRefinements = D({}, t.numericRefinements, C({}, S, void 0))), n
          },
          getWidgetState: function (e, t) {
            ...
            return 0 === i.length && 0 === s.length
              ? e
              : D({}, e, { range: D({}, e.range, C({}, S, ''.concat(i, ':').concat(s))) })
          },
          getWidgetSearchParameters: function (e, t) {
            var n = t.uiState,
              r = e.addDisjunctiveFacet(S).setQueryParameters({
  ...
  function Jn(x) {
    ...
    return (
      ...
      function () {
        ...
        if (!/^(and|or)$/.test(h))
          throw new Error(Kn('The `operator` must one of: `"and"`, `"or"` (got "'.concat(h, '").')))
        if (!0 === g && f <= p)
        ...
        return {
          ...
          getWidgetState: function (e, t) {
            var n = t.searchParameters,
              r = 'or' === h ? n.getDisjunctiveRefinements(m) : n.getConjunctiveRefinements(m)
            return r.length ? D({}, e, { refinementList: D({}, e.refinementList, C({}, m, r)) }) : e
          },
          getWidgetSearchParameters: function (e, t) {
            var n = t.uiState,
              r = 'or' === h,
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            return r
              ...
              : i.setQueryParameters({
                  disjunctiveFacetsRefinements: D({}, i.disjunctiveFacetsRefinements, C({}, m, []))
                })
          },
          _toggleRefinement: function (e, t) {
            var n = this._getRefinedStar(e.state) === Number(t)
            if ((e.removeDisjunctiveFacetRefinement(m), !n))
              for (var r = Number(t); r <= p; ++r) e.addDisjunctiveFacetRefinement(m, r)
            e.search()
          },
        ...
        return {
          ...
          render: function (e) {
            var t = e.helper,
              ...
              u = { isRefined: void 0 !== c && c.isRefined, count: void 0 === c ? null : c.count },
              l = p
                ? be(o, function (e) {
                    return e.name === Re(s)
                  })
      ...
      function () {
        ...
        return {
          ...
          getWidgetSearchParameters: function (e) {
            ...
            return e.addHierarchicalFacet({ name: s, attributes: t, separator: n, rootPath: i })
          }
        }
      }
    )
        ...
        function u(e) {
          return (
            ...
            (function (e) {
              var t = e.match(De)
              if (!t)
                throw new Error('Invalid value for "aroundLatLng" parameter: "'.concat(e, '"'))
  ...
  function mr(e, t) {
    ...
    return function (i) {
      ...
      return {
        ...
        getWidgetSearchParameters: function (e, t) {
          var n = t.uiState
          return He(e, new se.SearchParameters(D({}, n.configure, {}, i.searchParameters)))
        },
        getWidgetState: function (e) {
    ...
    return function (e) {
      ...
      var i = Object.keys(s).reduce(function (e, t) {
          ...
          return Array.isArray(r)
            ? [].concat(w(e), [
                r.map(function (e) {
                  return gr({ attributeName: t, attributeValue: e, attributeScore: i })
                })
              ])
            : 'string' == typeof r
              ? [].concat(w(e), [gr({ attributeName: t, attributeValue: r, attributeScore: i })])
              : e
        }, []),
        o = D(
          {},
        ...
        return {
          ...
          dispose: function (e) {
            var t = e.helper,
              n = e.state
            return (
              m(), l ? (t.removeListener('change', c), n.setQueryParameter('ruleContexts', h)) : n
            )
          }
        }
        function f(e) {
  ...
  function Sr(e) {
    ...
    function r() {
      return 'askingPermission' === v.status || 'waiting' === v.status || 'recognizing' === v.status
    }
    function i(e) {
                  ...
                  'function' == typeof o &&
                    n.setState(
                      n.state.setQueryParameters(
                        D(
                          { ignorePlurals: !0, removeStopWords: !0, optionalWords: e },
                          o({ query: e })
                        )
                      )
                    ),
            ...
            return {
              ...
              render: function (e) {
                var t = e.helper,
                  ...
                  i = n.map(function (e) {
                    return (
                      (e.results.hits = s ? Ze(e.results.hits) : e.results.hits),
                      {
                        indexId: e.indexId,
              ...
              getWidgetSearchParameters: function (e, t) {
                ...
                return s ? e.setQueryParameters(D({}, n, {}, Je)) : e.setQueryParameters(n)
              },
              dispose: function (e) {
                var t = e.state
                r()
        ...
        k(e, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return null === n
                ? null
                : ln(e, f({}, this.props.rootProps, { dangerouslySetInnerHTML: { __html: n } }))
            }
          }
        ]),
        e
      ...
      ln(
        ...
        !r &&
          ...
          ln(
            ...
            ln(
              Qr,
              { className: kr(t.redo, C({}, t.disabledRedo, !o)), disabled: !o, onClick: u },
              ln(jr, f({}, h, { templateKey: 'redo', rootTagName: 'span' }))
            )
          ),
        i &&
        ...
        p.maps.event.addListenerOnce(N.mapInstance, 'idle', function () {
          ...
          N.mapInstance.addListener('center_changed', e),
            ...
            N.mapInstance.addListener('idle', function () {
              N.isUserInteraction &&
                N.isPendingRefine &&
                ((N.isPendingRefine = !1), $r({ mapInstance: N.mapInstance, refine: a }))
            })
        }),
      ...
      return (
        ...
        C(y(s), 'onSubmit', function (e) {
          var t = s.props,
            ...
            i = t.onSubmit
          return (
            e.preventDefault(), e.stopPropagation(), s.input.blur(), n || r(s.state.query), i(e), !1
          )
        }),
        ...
        },
        {
          ...
          value: function (e) {
            var t = e.facetValueToRefine,
              n = e.originalEvent,
              r = e.isRefined
            if (!(le(n) || (r && n.target.parentNode.querySelector('input[type="radio"]:checked'))))
              ...
              'div',
              {
                className: kr(
                  ...
                  C(
                    ...
                    !this.props.facetValues || 0 === this.props.facetValues.length
                  ),
            ...
            r &&
              ln(
                ...
                f({}, u, {
                  ...
                  rootTagName: 'button',
                  rootProps: {
                    className: kr(c.loadPrevious, C({}, c.disabledLoadPrevious, s)),
                    disabled: s,
                    onClick: i
                  }
                })
      ...
      k(a, [
        {
          ...
          value: function (e) {
            var t = e.label,
              ...
              u = void 0 !== c && c,
              l = e.createURL,
              h = { item: kr(this.props.cssClasses.item, a), link: this.props.cssClasses.link }
            o
          ...
          value: function () {
            return ln(
              'div',
              {
                className: kr(
                  this.props.cssClasses.root,
                  C({}, this.props.cssClasses.noRefinementRoot, this.props.nbPages <= 1)
                )
              },
              ln(
                'ul',
                ...
                ln(
                  ...
                  ln(
                    ...
                    f({}, c, {
                      ...
                      rootTagName: 'button',
                      rootProps: { type: 'submit', className: o.submit, disabled: u }
                    })
                  )
                )
              )
  ...
  function Ji(e) {
    return ['rheostat', 'vertical' === e.orientation ? 'rheostat-vertical' : 'rheostat-horizontal']
      ...
      return (
        ...
        k(n, [
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (Object.prototype.hasOwnProperty.call(g, t))
                (f += g[t](m)),
                  l && (d < f ? p < u.length - 1 && (h = u[p + 1]) : 0 < p && (h = u[p - 1]))
            ...
            value: function (e) {
              this.setStartSlide(e, e.clientX, e.clientY),
                'function' == typeof document.addEventListener
                  ? (document.addEventListener('mousemove', this.handleMouseSlide, !1),
          ...
          },
          {
            ...
            value: function (e) {
              null !== this.state.slidingIndex && (this.handleSlide(e.clientX, e.clientY), Xi(e))
            }
          },
          {
              ...
              if (
                ...
                'function' == typeof document.removeEventListener
                  ? (document.removeEventListener('mouseup', this.endSlide, !1),
                    ...
                    document.removeEventListener('mousemove', this.handleMouseSlide, !1))
  ...
  function Ia(e) {
    ...
    return ln(
      ...
      ln(
        ...
        ln(
          'svg',
          { height: '1.2em', className: r.logo, viewBox: '0 0 168 24', style: { width: 'auto' } },
          ln('path', {
    ...
    ls = Object.freeze({
                ...
                k(u, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      ;(this.element.style.left = ''.concat(Math.round(e.x - this.offset.x), 'px')),
                        (this.element.style.top = ''.concat(Math.round(e.y - this.offset.y), 'px')),
            ...
            ? function (e) {
                ...
                return new I(
                  D({}, C.createOptions(t), {}, n, {
                    ...
                    template: ye({ templateKey: 'HTMLMarker', templates: N, data: t })
                  })
                )
              }
            : function (e) {
                ...
                return new R.maps.Marker(
                  D({}, F.createOptions(t), {}, n, { __id: t.objectID, position: t._geoloc })
                )
              },
          L = C || F
      ...
      hierarchicalMenu: function () {
        ...
        return zt(
          (function (e) {
            ...
            cssClasses: {
              root: kr(ri(), p.root),
              noRefinementRoot: kr(ri({ modifierName: 'noRefinement' }), p.noRefinementRoot),
              list: kr(ri({ descendantName: 'list' }), p.list),
              childList: kr(ri({ descendantName: 'list', modifierName: 'child' }), p.childList),
              item: kr(ri({ descendantName: 'item' }), p.item),
              selectedItem: kr(
                ri({ descendantName: 'item', modifierName: 'selected' }),
                p.selectedItem
              ),
              parentItem: kr(ri({ descendantName: 'item', modifierName: 'parent' }), p.parentItem),
              ...
              if (!t) {
                ...
                Cn(
                  ln(
                    'div',
                    { className: s.root },
                    ln(ui, { cssClasses: s, currentValue: i, options: n, setValue: r })
                  ),
                  a
                )
              }
      ...
      infiniteHits: function (e) {
        ...
        var l = ue(n),
          ...
          })({ containerNode: l, cssClasses: h, templates: s, showPrevious: u, renderState: {} })
      ...
      menu: function (e) {
        ...
        var f = ue(t),
          d = {
            root: kr(yi(), c.root),
            noRefinementRoot: kr(yi({ modifierName: 'noRefinement' }), c.noRefinementRoot),
        ...
        return An(
          ...
          })({ containerNode: f, cssClasses: d, renderState: {}, templates: l, showMore: a }),
          function () {
            return Cn(null, f)
          }
        )({ attribute: n, limit: i, showMore: a, showMoreLimit: s, sortBy: r, transformItems: h })
      },
        ...
        var w = !!u && Boolean(d),
          ...
          P = (function (e) {
            ...
            return (
              ...
              O(t, ['searchableReset', 'searchableSubmit', 'searchableLoadingIndicator'])
            )
          })(D({}, bi, {}, b)),
          _ = {
            root: kr(wi(), v.root),
            noRefinementRoot: kr(wi({ modifierName: 'noRefinement' }), v.noRefinementRoot),
            ...
            searchable: {
              ...
              submitIcon: kr(Si({ descendantName: 'submitIcon' }), v.searchableSubmitIcon),
              reset: kr(Si({ descendantName: 'reset' }), v.searchableReset),
              resetIcon: kr(Si({ descendantName: 'resetIcon' }), v.searchableResetIcon),
              loadingIndicator: kr(
                Si({ descendantName: 'loadingIndicator' }),
                v.searchableLoadingIndicator
              ),
              loadingIcon: kr(Si({ descendantName: 'loadingIcon' }), v.searchableLoadingIcon)
            }
          }
        return Jn(
          (function (e) {
            ...
            return function (e, t) {
              ...
              t
                ? (p.templateProps = fe({ templatesConfig: o.templatesConfig, templates: m }))
                : Cn(
                    ln(ei, {
                      createURL: i,
                      cssClasses: d,
      ...
      numericMenu: function () {
        ...
        var u = ue(t),
          l = {
            root: kr(xi(), a.root),
            noRefinementRoot: kr(xi({ modifierName: 'noRefinement' }), a.noRefinementRoot),
          ...
          })({ containerNode: u, attribute: n, cssClasses: l, renderState: {}, templates: o })
      ...
      pagination: function () {
        ...
        var y = ue(t),
          ...
          w = {
            root: kr(Ii(), a.root),
            noRefinementRoot: kr(Ii({ modifierName: 'noRefinement' }), a.noRefinementRoot),
            ...
            pageItem: kr(Ii({ descendantName: 'item', modifierName: 'page' }), a.pageItem),
            selectedItem: kr(
      ...
      rangeInput: function () {
        ...
        var h = ue(t),
          ...
          d = {
            ...
            inputMin: kr(ki({ descendantName: 'input', modifierName: 'min' }), c.inputMin),
            inputMax: kr(ki({ descendantName: 'input', modifierName: 'max' }), c.inputMax),
          ...
          zn(
            (function (e) {
              ...
              return function (e, t) {
                ...
                if (t) p.templateProps = fe({ templatesConfig: s.templatesConfig, templates: g })
                else {
                  var o = r.min,
                    c = r.max,
                    u = B(i, 2),
      ...
      searchBox: function () {
        ...
        var y = ue(t),
          b = {
            ...
            loadingIndicator: kr(Oi({ descendantName: 'loadingIndicator' }), a.loadingIndicator),
      ...
      rangeSlider: function () {
        ...
        return D(
          ...
          zn(
            ...
            })({ containerNode: m, step: o, pips: u, tooltips: d, renderState: {}, cssClasses: p }),
            function () {
              return Cn(null, m)
            }
              ...
              t ||
                Cn(
                  ln(
                    'div',
                    { className: s.root },
                    ln(ui, { cssClasses: s, currentValue: n, options: r, setValue: i })
                  ),
                  a
                )
            }
      ...
      ratingMenu: function () {
        ...
        var u = ue(t),
          l = {
            root: kr(ua(), s.root),
            noRefinementRoot: kr(ua({ modifierName: 'noRefinement' }), s.noRefinementRoot),
                ...
                : Cn(
                    ln(
                      ...
                      ln(
                        ...
                        ln(
                          'symbol',
                          { id: ua({ descendantName: 'starSymbol' }), viewBox: '0 0 24 24' },
                          la
                        ),
                        ln(
                          'symbol',
                          { id: ua({ descendantName: 'starEmptySymbol' }), viewBox: '0 0 24 24' },
                          ha
                        )
                      )
                    ),
      ...
      analytics: function () {
                ...
                for (var n in e)
                  if (e.hasOwnProperty(n)) {
                    ...
                    if (r.hasOwnProperty('>=') && r.hasOwnProperty('<='))
                      r['>='] && r['>='][0] === r['<='] && r['<='][0]
                        ? t.push(''.concat(n, '=').concat(n, '_').concat(r['>=']))
                        : t.push(
                            ''.concat(n, '=').concat(n, '_').concat(r['>='], 'to').concat(r['<='])
                          )
                    else if (r.hasOwnProperty('>='))
                      t.push(''.concat(n, '=').concat(n, '_from').concat(r['>=']))
                    else if (r.hasOwnProperty('<='))
        ...
        return (
          !0 === o && (m = !1),
          {
            init: function () {
              !0 === i &&
                (document.addEventListener('click', p), window.addEventListener('beforeunload', g))
            },
            render: function (e) {
              var t = e.results,
                n = e.state
      ...
      breadcrumb: function () {
        ...
        var h = ue(t),
          f = {
            root: kr(_a(), l.root),
            noRefinementRoot: kr(_a({ modifierName: 'noRefinement' }), l.noRefinementRoot),
      ...
      menuSelect: function (e) {
        ...
        var f = ue(t),
          d = {
            root: kr(Ca(), c.root),
            noRefinementRoot: kr(Ca({ modifierName: 'noRefinement' }), c.noRefinementRoot),
      ...
      poweredBy: function () {
        ...
        var s = ue(t),
          o = {
            root: kr(Ta(), Ta({ modifierName: 'dark' === a ? 'dark' : 'light' }), r.root),
      ...
      panel: function (e) {
        var t = 0 < arguments.length && void 0 !== e ? e : {},
          ...
          f = {
            root: kr(rs(), c.root),
            noRefinementRoot: kr(rs({ modifierName: 'noRefinement' }), c.noRefinementRoot),
            ...
            collapseButton: kr(rs({ descendantName: 'collapseButton' }), c.collapseButton),
        ...
        return function (n) {
          return function () {
            ...
            if (!i)
              throw new Error(
                ns('The `container` option is required in the widget within the panel.')
              )
            var t = {
                header: '',
                footer: '',
            ...
            return D({}, s, {
              ...
              render: function () {
                ...
                var r,
                  i = t[0]
                a({ options: i, hidden: Boolean(o(i)), collapsible: l, collapsed: Boolean(h(i)) }),
              ...
              c.on('clear', function () {
                ;(u.query = ''),
                  ...
                  1 < o.length
                    ...
                    : s
                        .setQueryParameter('aroundLatLngViaIP', u.initialLatLngViaIP)
          ...
          getWidgetSearchParameters: function (e, t) {
            ...
            return (
              ...
              u.isInitialLatLngViaIPSet ||
                ((u.isInitialLatLngViaIPSet = !0), (u.initialLatLngViaIP = e.aroundLatLngViaIP)),
              c.setVal(i),
              c.close(),
              e
                .setQueryParameter('insideBoundingBox', void 0)
