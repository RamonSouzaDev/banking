...
;(function (S, M) {
  ...
  M(J, 'parts/Utilities.js', [J['parts/Globals.js']], function (c) {
    ...
    c.normalizeTickInterval = function (d, a, b, l, f) {
      ...
      for (
        l = 0;
        l < a.length &&
        !((h = a[l]), (f && h * b >= d) || (!f && g <= (a[l] + (a[l + 1] || a[l])) / 2));
        l++
      );
  ...
  M(J, 'parts/Color.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
    ...
    c.Color.prototype = {
      ...
      init: function (e) {
        var v, q
        if (
          (this.input = e = this.names[e && e.toLowerCase ? e.toLowerCase() : ''] || e) &&
          e.stops
        )
    ...
    q(e.prototype, {
      ...
      init: function (a, b, d, n, z, t, l) {
        ...
        this.createElement('desc')
          .add()
          .element.appendChild(y.createTextNode('Created with Highcharts 8.0.0'))
                        ...
                        if (L)
                          ...
                          for (; m.length; )
                            m.length &&
                              ...
                              I(p, { dy: e, x: l }),
                              R && I(p, 'style', R),
                              p.appendChild(y.createTextNode(m.join(' ').replace(/- /g, '-'))),
                              b.appendChild(p)),
                              d.truncate(a, p, null, m, 0 === r ? x : 0, c, function (a, b) {
    ...
    c.Time.prototype = {
      ...
      makeTime: function (m, r, e, A, f, b) {
        if (this.useUTC) {
          ...
          d !== h
            ? (a += h - d)
            : d - 36e5 !== this.getTimezoneOffset(a - 36e5) || c.isSafari || (a -= 36e5)
      ...
      getTimeTicks: function (c, r, e, A) {
        ...
        if (F(r)) {
          ...
          h >= u.second &&
            f.set('Seconds', d, h >= u.minute ? 0 : k * Math.floor(f.get('Seconds', d) / k))
          h >= u.minute &&
            f.set('Minutes', d, h >= u.hour ? 0 : k * Math.floor(f.get('Minutes', d) / k))
  ...
  M(J, 'parts/Options.js', [J['parts/Globals.js']], function (c) {
    ...
    c.setOptions = function (e) {
      ...
      ;(e.time || e.global) &&
        c.time.update(F(c.defaultOptions.global, c.defaultOptions.time, e.global, e.time))
    ...
    c.Tick.prototype = {
        ...
        if ((t = x && x.list))
          c.shortenLabel = function () {
            for (g = 0; g < t.length; g++)
              if (
                (p.attr({
                  text: e.labelFormatter.call(v(c.formatCtx, { dateTimeLabelFormat: t[g] }))
                }),
      ...
      createLabel: function (c, e, m) {
        var f = this.axis,
          b = f.chart
        if (
          (c = G(e) && m.enabled ? b.renderer.text(e, c.x, c.y, m.useHTML).add(f.labelGroup) : null)
        )
      ...
      getLabelPosition: function (c, e, A, f, b, a, d, h) {
        var k = this.axis,
          ...
          t = b.y,
          x =
            f || k.reserveSpaceDefault ? 0 : -k.labelOffset * ('center' === k.labelAlign ? 0.5 : 1),
          L = {}
        G(t) ||
          (t =
            0 === k.side
        ...
        p &&
          ((A = (d / (h || 1)) % p), k.opposite && (A = p - A - 1), (e += (k.labelOffset / p) * A))
        L.x = c
        L.y = Math.round(e)
    ...
    B(e.prototype, {
      ...
      translate: function (a, b, d, g, f, h) {
        ...
        b
          ...
          : (f && (a = n.val2lin(a)),
            (a = w(g) ? z * (a - g) * t + c + z * l + (w(h) ? t * h : 0) : void 0))
        return a
      },
      ...
      renderUnsquish: function () {
        ...
        if (this.autoRotation)
          e > l && e > k.h ? (x.rotation = this.labelRotation) : (this.labelRotation = 0)
        else if (t) {
          var E = l
          if (!p) {
            var L = 'clip'
        ...
        x.rotation &&
          ((E = e > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : e), p || (L = 'ellipsis'))
        ...
        w || a.isLinked
          ? (f.forEach(function (b, d) {
            ...
            (a.reserveSpaceDefault =
              0 === t || 2 === t || { 1: 'left', 3: 'right' }[t] === a.labelAlign),
    ...
    function (c, e, F) {
      ...
      C(e.prototype, {
        ...
        removePlotBandOrLine: function (c) {
          for (
            var e = this.plotLinesAndBands, m = this.options, A = this.userOptions, f = e.length;
            f--;

          )
            e[f].id === c && e[f].destroy()
          ;[m.plotLines || [], A.plotLines || [], m.plotBands || [], A.plotBands || []].forEach(
            function (b) {
    ...
    c.Tooltip.prototype = {
      ...
      applyFilter: function () {
        ...
        c.renderer.definition({
          tagName: 'style',
          textContent:
            '.highcharts-tooltip-' + c.index + '{filter:url(#drop-shadow-' + c.index + ')}'
        })
      },
      getLabel: function () {
        var e = this,
        ...
        this.followPointer && f
          ...
          : c[0].tooltipPos
            ...
            : (c.forEach(function (a) {
                ...
                e +=
                  (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!d && p ? p.top - h : 0)
              }),
              (l /= c.length),
              (e /= c.length),
              (c = [
      ...
      getPosition: function (c, f, b) {
        var a = this.chart,
          ...
          A = function (a, b, g, f, c) {
            ...
            c < d || c > b - d
              ? (t = !1)
              : (h[a] = c < g / 2 ? 1 : c > b - f / 2 ? b - f - 2 : c - g / 2)
            return t
          },
          u = function (a) {
            var b = z
      ...
      setDOMEvents: function () {
        ...
        c.hasTouch &&
          ...
          c.unbindDocumentTouchEnd ||
            (c.unbindDocumentTouchEnd = w(f, 'touchend', a.onDocumentTouchEnd)))
      },
      destroy: function () {
        var a = this
          ...
          if (
            ...
            if ('touchmove' === e.type) {
              ...
              var u = q[0]
                ? 4 <=
                  Math.sqrt(
                    Math.pow(q[0].chartX - e.chartX, 2) + Math.pow(q[0].chartY - e.chartY, 2)
                  )
                : !1
            }
            I(u, !0) && this.pinch(e)
    ...
    c.Legend.prototype = {
      ...
      colorizeItem: function (b, a) {
        ...
        if (!this.chart.styledMode) {
          ...
          f && f.attr({ stroke: p })
          e &&
            (g && e.isMarker && ((t = b.pointAttribs()), a || (t.stroke = t.fill = m)), e.attr(t))
        }
      ...
      layoutItem: function (b) {
        ...
        this.offsetWidth =
          this.widthOption ||
          Math.max((c ? this.itemX - d - (b.checkbox ? 0 : p) : a) + d, this.offsetWidth)
      },
      ...
      render: function () {
        ...
        f ||
          ((this.box = f =
            a.rect().addClass('highcharts-legend-box').attr({ r: e.borderRadius }).add(d)),
          (f.isNew = !0))
        b.styledMode ||
          f
            .attr({
    ...
    q(Q.prototype, {
      ...
      drawChartBox: function () {
        var a = this.options.chart,
          ...
          N = 'animate'
        c ||
          ((this.chartBackground = c = b.rect().addClass('highcharts-background').add()),
          (N = 'attr'))
  ...
  M(
    ...
    function (c, e) {
      ...
      e.prototype.applyFixed = function () {
        ...
        H &&
          (v.scrollPositionX &&
            (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * v.scrollPositionX),
          v.scrollPositionY &&
            (this.scrollingContainer.scrollTop = this.scrollablePixelsY * v.scrollPositionY))
        q = this.axisOffset
  ...
  M(J, 'parts/Point.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
    ...
    c.Point.prototype = {
      ...
      firePointEvent: function (c, b, a) {
        ...
        ;(f.point.events[c] || (d.options && d.options.events && d.options.events[c])) &&
          this.importEvents()
        'click' === c &&
          f.allowPointSelect &&
          (a = function (a) {
      ...
      },
      {
        ...
        updateData: function (a, b) {
          ...
          a.forEach(function (a, b) {
            var h =
              (q(a) && this.pointClass.prototype.optionsToObject.call({ series: this }, a)) || {}
            var n = h.x
            if (h.id || w(n)) {
              if (
        ...
        animate: function (a) {
          ...
          if (a) this.setClip(d)
            ...
            a && a.animate(g, d)
            b[c + 'm'] &&
              b[c + 'm'].animate({ width: g.width + 99, x: g.x - (b.inverted ? 0 : 99) }, d)
            this.animate = null
          }
        },
        ...
        drawGraph: function () {
          ...
          f.forEach(function (f, g) {
            ...
            h
              ...
              : d.length &&
                (a[e] = h =
                  a.chart.renderer.path(d).addClass(f[1]).attr({ zIndex: 1 }).add(a.group))
            h &&
              !c &&
              ((e = {
                stroke: f[2],
        ...
        getZonesGraphs: function (a) {
          this.zones.forEach(function (b, d) {
            ...
            this.chart.styledMode ||
              d.push(b.color || this.color, b.dashStyle || this.options.dashStyle)
            a.push(d)
          }, this)
          return a
        },
        ...
        for (g = 0; g < r; g++) {
          ...
          'percent' === D
            ? ((p = p ? a : d),
              h && l[p] && l[p][t]
                ? ((p = l[p][t]),
                  (n.total = p.total = Math.max(p.total, n.total) + Math.abs(x) || 0))
    ...
    G(l.prototype, {
      ...
      update: function (a, b) {
        ...
        k &&
          ...
          a.data &&
            (a.dataSorting && G(f.options.dataSorting, a.dataSorting), this.setData(a.data, !1)))
        a = h(
          e,
          w,
          {
          ...
          B.forEach(function (q) {
            ...
            m
              ...
              : ((u.zIndex = 0),
                ...
                (m.isArea = !0))
            c.chart.styledMode ||
              (u.fill = I(q[3], G(q[2]).setOpacity(I(C.fillOpacity, 0.75)).get()))
            m[r](u)
            m.startX = e.xMap
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          c.columnMetrics = {
            width: e,
            offset:
              (l - e) / 2 + (k + ((c.columnIndex || 0) + (f ? 1 : 0)) * l - h / 2) * (f ? -1 : 1)
          }
    ...
    D(
      ...
      },
      {
        ...
        updateTotals: function () {
          ...
          for (c = 0; c < d; c++)
            (k = a[c]),
              (k.percentage = 0 < b && (k.visible || !e) ? (k.y / b) * 100 : 0),
              (k.total = b)
        },
        generatePoints: function () {
  ...
  M(J, 'parts/DataLabels.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
                  ...
                  : ((c.dataLabels = c.dataLabels || []),
                    (l = c.dataLabels[g] =
                      y
                        ...
                        : v.label(q, 0, -9999, a.shape, null, null, a.useHTML, null, 'data-label')),
                    g || (c.dataLabel = l),
                    l.addClass(
    ...
    D.prototype.alignDataLabel = function (b, a, c, e, f) {
      ...
      if (A) {
        ...
        w && 0 <= e.height
          ...
          : B(c.crop, !0) &&
            (A = h.isInsidePlot(k.x, k.y) && h.isInsidePlot(k.x + q.width, k.y + q.height))
        if (c.shape && !r)
          a[f ? 'attr' : 'animate']({
    ...
    D.prototype.justifyDataLabel = function (b, a, c, e, f, l) {
      ...
      m = c.y + k
      0 > m &&
        ('bottom' === g ? ((a.verticalAlign = 'top'), (a.inside = !0)) : (a.y = -m), (q = !0))
      m = c.y + e.height - k
      m > d.plotHeight &&
        ('top' === g ? ((a.verticalAlign = 'bottom'), (a.inside = !0)) : (a.y = d.plotHeight - m),
        (q = !0))
        ...
        ;(this.series || []).forEach(function (e) {
          ...
          e.visible &&
            ...
            e.points.forEach(function (e) {
              e.visible &&
                (F(e.dataLabels) ? e.dataLabels : e.dataLabel ? [e.dataLabel] : []).forEach(
                  function (q) {
                    var m = q.options
