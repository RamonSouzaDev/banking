;(function (root, factory) {
        ...
        function (projectedValue, index) {
          ...
          if (axisOptions.showGrid) {
            Chartist.createGrid(
              ...
              gridGroup,
              [chartOptions.classNames.grid, chartOptions.classNames[this.units.dir]],
              eventEmitter
            )
          }
  ...
  ;(function (globalRoot, Chartist) {
    ...
    function projectValue(value) {
      return (
        (this.axisLength * (+Chartist.getMultiValue(value, this.units.pos) - this.bounds.min)) /
        this.bounds.range
      )
    }
  ...
  ;(function (globalRoot, Chartist) {
    ...
    function projectValue(value) {
      return (
        (this.axisLength * (+Chartist.getMultiValue(value, this.units.pos) - this.range.min)) /
        ...
        function (series, seriesIndex) {
          ...
          seriesElement.addClass(
            [
              ...
              series.className ||
                options.classNames.series + '-' + Chartist.alphaNumerate(seriesIndex)
            ].join(' ')
          )
          ...
          data.normalized.series[seriesIndex].forEach(
            function (value, valueIndex) {
              var p = {
                x:
                  chartRect.x1 +
                  axisX.projectValue(value, valueIndex, data.normalized.series[seriesIndex]),
                y:
                  chartRect.y1 -
                  axisY.projectValue(value, valueIndex, data.normalized.series[seriesIndex])
              }
          ...
          if (seriesOptions.showArea && axisY.range) {
            ...
            path
              ...
              .map(function convertToArea(solidPathSegments) {
                ...
                var lastElement =
                  solidPathSegments.pathElements[solidPathSegments.pathElements.length - 1]
    ...
    function createChart(options) {
      ...
      data.raw.series.forEach(
        function (series, index) {
          ...
          var endAngle =
            totalDataSum > 0 ? startAngle + (data.normalized.series[index] / totalDataSum) * 360 : 0
