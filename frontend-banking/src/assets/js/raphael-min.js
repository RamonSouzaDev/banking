  ...
  (function (a, b) {
            ...
            if (i[z](y) && (db[z](y) || d.paper.customAttributes[z](y)))
              switch (((r[y] = d.attr(y)), null == r[y] && (r[y] = cb[y]), (s[y] = i[y]), db[y])) {
                ...
                case 'transform':
                  ...
                  if (H)
                    for (
                      r[y] = H.from, s[y] = H.to, t[y] = [], t[y].real = !0, v = 0, x = r[y].length;
                      x > v;
                      v++
                    )
      ...
      function i(i) {
        ...
        if (((this._drag.id = i.identifier), F && i.touches))
          for (var n, o = i.touches.length; o--; )
            if (
              ((n = i.touches[o]), (this._drag.id = n.identifier), n.identifier == this._drag.id)
            ) {
    ...
    ;($b.animateWith = function (a, b, d, e, f, g) {
      ...
      ($b.onAnimation = function (a) {
        return (
          a ? b.on('raphael.anim.frame.' + this.id, a) : b.unbind('raphael.anim.frame.' + this.id),
          this
        )
      }),
        ...
        if (c.svg) {
          ...
          ;(z.prototype = A),
            ...
            (A.insertBefore = function (a) {
              ...
              return (
                b.parentNode.insertBefore(this.node, b), c._insertbefore(this, a, this.paper), this
              )
            }),
            (A.blur = function (a) {
              var b = this
