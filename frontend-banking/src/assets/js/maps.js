    ...
    QJ7E: function (t, e, n) {
      ...
      var Ne = Array.prototype,
        ze =
          ...
          function (t, e, n) {
            ...
            for (
              var i = -1, r = 0 | Math.max(0, Math.ceil((e - t) / n)), o = new Array(r);
              ++i < r;
        ...
        return (
          ...
          (m.outline = function () {
            return {
              type: 'Polygon',
              coordinates: [
                l(i).concat(h(a).slice(1), l(n).reverse().slice(1), h(u).reverse().slice(1))
              ]
            }
          }),
          (m.extent = function (t) {
      ...
      var _i = function (t, e) {
          ...
          function o(t) {
            return (
              t &&
                ('function' == typeof r && i.pointRadius(+r.apply(this, arguments)), et(t, n(i))),
              i.result()
            )
          }
          return (
            ...
            if (this.series) {
              ...
              if (this.multiPolygon) {
                ...
                if (this.series.calculateVisualCenter) {
                  ...
                  (this._visualLongitude = this.longitude), (this._visualLatitude = this.latitude)
              }
            }
            t.prototype.validate.call(this)
          }),
                          ...
                          if (o) {
                            ...
                            if (
                              ...
                              c
                                ...
                                : ((c = { multiPolygon: s, id: u, madeFromGeoData: !0 }),
                                  r.data.push(c)),
        ...
        $r = (function (t) {
          ...
          return (
            ...
            (e.prototype.updateMapSize = function () {
              if (this.chart) {
                var t =
                  (this.chart.scaleRatio * Math.min(this.percentWidth, this.percentHeight)) / 100
                ...
                if (
                  ...
                  n &&
                    n.series.each(function (t) {
                      t instanceof so &&
                        (t.isReady() ||
                          e._disposers.push(t.events.on('ready', e.handleImagesToConnect, e, !1)))
                    })
                }
              },
              enumerable: !0,
                            ...
                            if ('LineString' == a || 'MultiLineString' == a) {
                              ...
                              'LineString' == a && (s = [s]),
                                c
                                  ...
                                  : ((c = { multiLine: s, id: u, madeFromGeoData: !0 }),
                                    r.data.push(c)),
                                Zr.softCopyProperties(i.properties, c)
                            }
                          }
          ...
          return (
            ...
            (e.prototype.updateExtremes = function () {
              ...
              if (
                ...
                if (
                  ((this.east = t), (this.west = n), (this.north = e), (this.south = i), s.rotate)
                ) {
                  var c = s.rotate(),
                    l = c[0],
                    h = c[1],
      ...
      Sa.invert = function (t, e) {
        ...
        do {
          ;(i = r - $o * Zo(o)),
            (o -= n =
              (Zo(2 * o) + 2 * o - Uo * Zo(i)) / (2 * Fo(2 * o) + 2 + Uo * Fo(i) * $o * Fo(o)))
        } while (Do(n) > Xo && --a > 0)
      ...
      uu.invert = function (t, e) {
        ...
        do {
          a -= n =
            (a * (1.01183 + (r = (i = a * a) * i) * r * (0.01926 * i - 0.02625 - 0.00396 * r)) -
              e) /
      ...
      bu.invert = function (t, e) {
        ...
        return (
          (a = qo(r)),
          [(Do(e) < Do(r + 1 / a) ? ra(t * a) : Ho(t) * (oa(Do(t * a)) + Jo)) / Zo(r), r]
        )
      }
      var Pu = [
          [0, 90],
        ...
        var i = n / Jo,
          ...
          d =
            (p * (s + a - 1) +
              2 *
                aa(
                  s * (r + a * f - 1) + (1 - r) * (r * (c * c + 4 * a) + 12 * u * a + 4 * a * a)
                )) /
            (4 * s + f)
    ...
    U8r1: function (t, e, n) {
      ...
      function r(t, e, n) {
        ...
        for (var S = v.length; v.length; ) {
          ...
          _.d > b.d &&
            ((b = _),
            n && console.log('found best %d after %d probes', Math.round(1e4 * _.d) / 1e4, S)),
            _.max - b.d <= e ||
              ((g = _.h / 2),
        ...
        return (
          n && (console.log('num probes: ' + S), console.log('best distance: ' + b.d)), [b.x, b.y]
        )
      }
      function o(t, e) {
        return e.max - t.max
