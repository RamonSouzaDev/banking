  ...
  return (function t(e, r, n) {
  ...
  })(
    {
      ...
      2: [
        function (e, t, r) {
          ...
          function i(e) {
            ...
            for (
              var t = ('string' == typeof e ? e : '').split(/[\s,]+/), n = t.length, o = 0;
              o < n;
              o++
            )
              t[o] &&
        ...
        function (t, r, n) {
          ;(function (o, i) {
            !(function (t, o) {
              ...
              function T(e, t, n) {
                t.constructor === e.constructor && n === h && t.constructor.resolve === y
                  ? x(e, t)
                  : n === ue
              ...
              function j(e, t) {
                e._state === ie &&
                  ((e._result = t), (e._state = ae), 0 !== e._subscribers.length && Y(R, e))
              }
              function O(e, t) {
              ...
              function I(e, t, n, o) {
                ...
                if (i) {
                  if (
                    ((a = q(n, o)),
                    a === ce ? ((c = !0), (s = a.error), (a.error = null)) : (u = !0),
                    t === a)
                  )
                    return void O(t, v())
                } else (a = o), (u = !0)
                t._state !== ie ||
                  (i && u ? S(t, a) : c ? O(t, s) : e === ae ? j(t, a) : e === se && O(t, a))
              }
              function E(e, t) {
                try {
                  t(
              ...
              function L(e) {
                ;(this[oe] = N()),
                  ...
                  (this._subscribers = []),
                  m !== e && ('function' != typeof e && F(), this instanceof L ? E(this, e) : $())
              }
              function B() {
                var e = void 0
              ...
              return (
                ...
                (U.prototype._settledAt = function (e, t, r) {
                  var n = this.promise
                  n._state === ie &&
                    (this._remaining--, e === se ? O(n, r) : (this._result[t] = r)),
        ...
        function (e, t, r) {
          ...
          var n = Object.prototype.hasOwnProperty,
            ...
            y = function (e) {
              ...
              if (i && e.length > 0) for (var y = 0; y < e.length; ++y) p.push(String(y))
              else for (var m in e) (f && 'prototype' === m) || !n.call(e, m) || p.push(String(m))
              if (u)
                for (var g = h(e), v = 0; v < l.length; ++v)
                  (g && 'constructor' === l[v]) || !n.call(e, l[v]) || p.push(l[v])
              return p
            }
          ;(y.shim = function () {
            if (Object.keys) {
          ...
          t.exports = function (e, t, r, i) {
            ...
            for (var l = 0; l < c; ++l) {
              var p,
                ...
                y = e[l].replace(s, '%20'),
                m = y.indexOf(r)
              m >= 0 ? ((p = y.substr(0, m)), (f = y.substr(m + 1))) : ((p = y), (f = '')),
      ...
      15: [
          ...
          ;(function (r) {
            function n(t, r, n) {
              ...
              ;(this.applicationID = t),
                ...
                (n = n || {}),
                (this._timeouts = n.timeouts || { connect: 1e3, read: 2e3, write: 3e4 }),
                n.timeout &&
                  (this._timeouts.connect = this._timeouts.read = this._timeouts.write = n.timeout)
              var p = n.protocol || 'https:'
              if ((/:$/.test(p) || (p += ':'), 'http:' !== p && 'https:' !== p))
                throw new u.AlgoliaSearchError(
                  'protocol must be `http:` or `https:` (was `' + n.protocol + '`)'
                )
              if ((this._checkAppIdData(), n.hosts))
                s(n.hosts)
                  ? ((this.hosts.read = a(n.hosts)), (this.hosts.write = a(n.hosts)))
                  : ((this.hosts.read = a(n.hosts.read)), (this.hosts.write = a(n.hosts.write)))
              else {
              ...
              ;(this.hosts.read = c(this.hosts.read, o(p))),
                ...
                (this.cache = n._cache || {}),
                (this._ua = n._ua),
                (this._useCache = !(void 0 !== n._useCache && !n._cache) || n._useCache),
            ...
            function a(e) {
              for (var t, r, n = e.length; 0 !== n; )
                (r = Math.floor(Math.random() * n)), (n -= 1), (t = e[n]), (e[n] = e[r]), (e[r] = t)
              return e
            }
            function s(e) {
              var t = {}
            ...
            ;(n.prototype.initIndex = function (e) {
              ...
              (n.prototype._jsonRequest = function (t) {
                function r(e, o) {
                  function c(e) {
                    ...
                    if (
                      ...
                      return (
                        m._useCache && !m._useRequestCache && y && (y[l] = e.responseText),
                  ...
                  if (
                    ...
                    m._useCache && !m._useRequestCache && a && (l += '_body_' + o.body),
                    n(!m._useRequestCache, y, l))
                  ) {
                    d('serving response from cache')
                    var S = y[l]
                    return m._promise.resolve({ body: JSON.parse(S), responseText: S })
                  }
                  if (g >= m.hosts[t.hostType].length)
                    return !b || v
                      ...
                      : (d('switching to fallback'),
                        ...
                        (p = m._computeRequestHeaders({ additionalUA: h, headers: t.headers })),
                        (o.timeouts = m._getTimeoutsForRequest(t.hostType)),
                ...
                (void 0 !== t.body.params || void 0 !== t.body.requests)
                  ...
                  : (p = this._computeRequestHeaders({ additionalUA: h, headers: t.headers })),
                ...
                if (
                  ...
                  var _ = y[l],
                    x = 'function' != typeof _.then ? m._promise.resolve({ responseText: _ }) : _
                ...
                for (var r in e)
                  null !== r &&
                    ...
                    (t +=
                      ...
                      '=' +
                      encodeURIComponent(
                        '[object Array]' === Object.prototype.toString.call(e[r]) ? i(e[r]) : e[r]
                      )))
                return t
              }),
              (n.prototype._computeRequestHeaders = function (t) {
                var r = e(4),
                  ...
                  o = { 'x-algolia-agent': n, 'x-algolia-application-id': this.applicationID }
                return (
                ...
                var s = this,
                  u = {
                    requests: i(t, function (e) {
                      var t = ''
                      return (
                        void 0 !== e.query && (t += 'query=' + encodeURIComponent(e.query)),
                        { indexName: e.indexName, params: s._getSearchParams(e.params, t) }
                      )
                    })
                  },
                  c = i(u.requests, function (e, t) {
                    return (
                      ...
                      '=' +
                      encodeURIComponent(
                        '/1/indexes/' + encodeURIComponent(e.indexName) + '?' + e.params
                      )
                    )
                  }).join('&'),
                  l = '/1/indexes/*/queries'
              ...
              (n.prototype._setHostIndexByType = function (t, r) {
                ...
                return (o[r] = t), this._partialAppIdDataUpdate({ hostIndexes: o }), t
              }),
        ...
        { 1: 1, 11: 11, 16: 16, 22: 22, 25: 25, 26: 26, 27: 27, 29: 29, 31: 31, 4: 4, 7: 7 }
      ],
      16: [
        function (e, t, r) {
          function n(e, t) {
          ...
          ;(t.exports = n),
                ...
                : 'number' == typeof arguments[0]
                  ? ((o = arguments[0]),
                    'number' == typeof arguments[1]
                      ? (i = arguments[1])
                      : 'function' == typeof arguments[1] && ((n = arguments[1]), (i = void 0)),
                    (t = void 0),
                    (r = void 0))
            ...
            (n.prototype.getObject = function (e, t, r) {
              ...
              return this.as._jsonRequest({
                method: 'GET',
                url:
                  '/1/indexes/' + encodeURIComponent(n.indexName) + '/' + encodeURIComponent(e) + o,
                hostType: 'read',
                callback: r
              })
            }),
      ...
      18: [
        ...
        { 1: 1, 11: 11, 19: 19, 20: 20, 22: 22, 25: 25, 3: 3, 30: 30, 32: 32, 5: 5, 6: 6 }
      ],
      19: [
        function (e, t, r) {
          'use strict'
      ...
      20: [
        function (e, t, r) {
          ...
          function n(e, t, r) {
            function n() {
              t.debug('JSONP: success'),
                m ||
                  ...
                  ((m = !0),
                  p ||
                    (t.debug('JSONP: Fail. Script loaded but did not call the callback'),
                    s(),
            ...
            if ('GET' !== t.method)
              return void r(
                new Error('Method ' + t.method + ' ' + e + ' is not supported by JSONP.')
              )
            t.debug('JSONP: start')
            var p = !1,
              f = !1
            ...
            ;(window[y] = function (e) {
              return (
                ...
                f
                  ...
                  : ((p = !0), s(), void r(null, { body: e, responseText: JSON.stringify(e) }))
              )
            }),
              (e += '&callback=' + y),
        ...
        function (e, t, r) {
          function n(e, t) {
            return function (r, n, i) {
              if (('function' == typeof r && 'object' == typeof n) || 'object' == typeof i)
              ...
              return (
                void 0 !== n &&
                  (n.additionalUA && ((s = n.additionalUA), delete n.additionalUA),
        ...
        function (e, t, r) {
          ...
          function n(t, r) {
            ...
            'function' == typeof Error.captureStackTrace
              ...
              : (o.stack = new Error().stack || 'Cannot get a stacktrace, browser is too old'),
          ...
          function n(t) {
            return function (r, n, a) {
              ...
              ;(a = (a && s(a)) || {}),
                ...
                (0 !== arguments.length && 'object' != typeof r && void 0 !== r) ||
      ...
      31: [
        function (e, t, r) {
          ;(function (r) {
            ...
            function i() {
              try {
                return (
                  'localStorage' in r &&
                  null !== r.localStorage &&
                  (r.localStorage[c] || r.localStorage.setItem(c, JSON.stringify({})), !0)
                )
              } catch (e) {
                return !1
              }
            ...
            ;(s = i() ? p : l), (t.exports = { get: o, set: o, supportsLocalStorage: i })
          }).call(
            this,
            'undefined' != typeof global
              ? global
