                  ...
                  <div class="iq-card-body">
                     <div class="table-responsive">
                        <div class="row justify-content-between">
                           <div class="col-sm-12 col-md-6">
                              <div id="user_list_datatable_info" class="dataTables_filter">
                                 <form action="{{ route('users.index') }}" method="GET" class="mr-3 position-relative">
                        ...
                        <div class="container-fluid">
                           <div class="row justify-content-end">
                              <form action="{{ route('users.create') }}" class="mr-2">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <div class="d-flex align-items-center list-user-action">
                                       ...
                                       <form action="{{ route('users.edit', $user->id) }}" method="GET" class="mr-2">
                     ...
                     <div class="row justify-content-between mt-3">
                        <div id="user-list-page-info" class="col-md-6">
                           <span>Exibindo {{ $users->firstItem() }} a {{ $users->lastItem() }} de {{ $users->total() }} registros</span>
                        </div>
                        <div class="col-md-6">
                           <nav aria-label="Navegação de páginas">
                              <ul class="pagination justify-content-end mb-0">
                                 <li class="page-item {{ ($users->onFirstPage()) ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $users->previousPageUrl() }}" tabindex="-1" aria-disabled="true">Anterior</a>
                                 </li>
