    ...
    XFs4: function (e, t, i) {
        ...
        L = (function (e) {
          ...
          return (
            ...
            (t.prototype.positionToCoordinate = function (e) {
              ...
              return (
                (t = i.renderer.inversed ? (i.end - e) * n + r : (e - i.start) * n + r),
                u.round(t, 1)
              )
            }),
            (t.prototype.pointToPosition = function (e) {
      ...
      var M = i('2I/e'),
        ...
        B = (function (e) {
          function t() {
            var t = e.call(this) || this
            return (
              (t.className = 'PieSeries3DDataItem'), (t.values.depthValue = {}), t.applyTheme(), t
            )
          }
          return (
            r.c(t, e),
      ...
      var ve = (function (e) {
        ...
        return (
          ...
          (t.prototype.positionBullet = function (e) {
            e &&
              ((e.x = this.measuredWidth * e.locationX), (e.y = this.measuredHeight * e.locationY))
          }),
          ...
          return (
            ...
            (t.prototype.validate = function () {
              ...
              k.each(this._sorted, function (e) {
                ...
                if (
                  (d / a < t.minNodeSize && (d = a * t.minNodeSize), 'horizontal' == t.orientation)
                ) {
                    ...
                    k.each(this._sorted, function (e) {
                      ...
                      'horizontal' == i.orientation
                        ? ((a.dx = -(n.pixelWidth - a.pixelWidth) / Math.max(i._levelCount, 1)),
                          (t = 'dx'))
                        : ((a.dy = -(n.pixelHeight - a.pixelHeight) / Math.max(i._levelCount, 1)),
                          (t = 'dy'))
                      var o = 0,
          ...
          function t() {
            ...
            return (
              ...
              t.adapter.add('tooltipX', function (e, t) {
                return (
                  t.slice.ix * (t.slice.radius - (t.slice.radius - t.slice.pixelInnerRadius) / 2)
                )
              }),
              t.adapter.add('tooltipY', function (e, t) {
                return (
                  t.slice.iy * (t.slice.radius - (t.slice.radius - t.slice.pixelInnerRadius) / 2)
                )
              }),
              t
            )
              ...
              if ((e.prototype.validate.call(this), !this.isTemplate)) {
                ...
                if ((o && ((c = o.pixelX + o.dx), (p = o.pixelY + o.dy)), r > 0)) {
                  ...
                  ;(v += h.arcTo(t, n, r)),
                    ...
                    this.maskBullets &&
                      ((this.bulletsMask.path = v), (this.bulletsContainer.mask = this.bulletsMask))
                  var x = t + n / 2,
                    b = i + n / 2,
                    P = this.middleLine
                  ;(P.x1 = r * u.cos(x) + s),
        ...
        We = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t.prototype, 'chart', {
              ...
              set: function (e) {
                e &&
                  this._chart.set(e, e.events.on('propertychanged', this.handle3DChanged, this, !1))
              },
              enumerable: !0,
              configurable: !0
            }),
          ...
          return (
            ...
            (t.prototype.fixLayout = function () {
              ;(this.chartContainer.marginTop = -this.dy3D),
                ...
                this.scrollbarX &&
                  ((this.scrollbarX.dy = this.dy3D), (this.scrollbarX.dx = this.dx3D)),
                this.scrollbarY &&
                  ((this.scrollbarY.dy = this.dy3D), (this.scrollbarY.dx = this.dx3D)),
                this.fixColumns(),
        ...
        Ut = (function (e) {
          ...
          return (
            ...
            (t.prototype.validateDataElement = function (t) {
              var i
              if (
                (e.prototype.validateDataElement.call(this, t), t.index < this.dataItems.length - 1)
              ) {
        ...
        Qt = (function (e) {
          ...
          return (
            ...
            (t.prototype.triggerMoveReal = function (t) {
              ;(this.xAxis &&
                (!this.xAxis ||
                  (this.xAxis.cursorTooltipEnabled && !this.xAxis.tooltip.disabled))) ||
